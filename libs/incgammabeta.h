/* Copyright (C) 2007 by Numerical Recipes Software
   All rights reserved.
   Permission is granted to use this file for inclusion in the supplied cMchecker.cpp and for no other purpose. */
...
const Doub Gamma::FPMIN = 2.22507e-308 / EPS; //numeric_limits<Doub>::min()/EPS;
...
const Doub Beta::FPMIN = 2.22507e-308 / EPS; //numeric_limits<Doub>::min()/EPS;
