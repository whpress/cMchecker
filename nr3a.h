...
// NR3A Numerical Recipes class library with augmented functionality
// This file nr3a.h is backwards compatible with nr3.h
...
// WHP 2/20/2014 NR3A enhancements
...
template <class T> \
NRvector<T>& NAME(char *inplace, NRvector<T> &a) { \
	int i, n=a.size(); \
...
template <class T> \
NRmatrix<T>& NAME(char *inplace, NRmatrix<T> &a) { \
...
char nr_out_float_format[] = "%.5f ";
char nr_out_fixed_format[] = "%d ";
char nr_out_ullong_format[] = "%016llx ";
char nr_out_unsignedfixed_format[] = "%x ";
char nr_in_float_format[] = "%lf";
char nr_in_fixed_format[] ="%d";

char *nr_out_format(Doub x) {return nr_out_float_format;}
char *nr_out_format(Int x) {return nr_out_fixed_format;}
char *nr_out_format(Uint x) {return nr_out_unsignedfixed_format;}
char *nr_out_format(Ullong x) {return nr_out_ullong_format;}
char *nr_out_format(Uchar x) {return nr_out_fixed_format;}
char *nr_in_format(Doub x) {return nr_in_float_format;}
char *nr_in_format(Int x) {return nr_in_fixed_format;}
char *nr_in_format(Uchar x) {return nr_in_fixed_format;}
